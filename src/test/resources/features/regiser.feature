Feature: Register a new user
  ...
  Scenario: Register a new user with all details
    Given a new user with the following details:
      ...
      |2015 | Hari   | Harry@1234 | 9874541574    | harryish@gmail.net | reader.result | Question | Yes      |
  ...
  Scenario: Delete an existing user
    Given an existing user details:
      | id   | username | password  | phoneNumber | email             | profile | csvData | verified |
      | 3002 | Hari     | Harry@1234 | 9874541574    | harry@gmail.net | reader.result | Question | No      |
    When I send a DELETE request to "/api/v1/registers/3002"
