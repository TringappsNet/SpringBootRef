...
public class ControllerTest {
    ...
    public void testEditRegister() throws Exception {
        Integer id = 1;
        RegisterRequest request = new RegisterRequest("Anand", "Anand", 1344, "88838", "anand@mail.com", "Nil", "Junit.csv");
    ...
    public void testSaveRegister_Success() throws Exception {
        ...
        RegisterRequest request = new RegisterRequest("Anand","Anand", 8765, "88838", "anand@mail.com", "Nil", "Junit.csv");
        String jsonRequest = new ObjectMapper().writeValueAsString(request);
